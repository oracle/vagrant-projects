...
#   'opatch apply'. The True Cache node runs a single-instance database home
...
#
#   Runs as the oracle user, after the software install and root.sh but BEFORE
#   the True Cache instance is created. Patching before instance creation means
#   no instance is ever running when opatch applies the binary patch.
#------------------------------------------------------------------------------
