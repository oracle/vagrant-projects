...
then
  # Setting-up /u01 disk
  sh /vagrant_scripts/01_setup_u01.sh $BOX_DISK_NUM virtualbox
  ...
  sh /vagrant_scripts/05_setup_shared_disks.sh $BOX_DISK_NUM virtualbox
  ...
  echo "-----------------------------------------------------------------"
  expect /vagrant_scripts/07_setup_user_equ.expect grid   ${GRID_PASSWORD}   ${NODE1_HOSTNAME} ${NODE1_HOSTNAME} ${GI_HOME}/oui/prov/resources/scripts/sshUserSetup.sh
  expect /vagrant_scripts/07_setup_user_equ.expect oracle ${ORACLE_PASSWORD} ${NODE1_HOSTNAME} ${NODE1_HOSTNAME} ${GI_HOME}/oui/prov/resources/scripts/sshUserSetup.sh
  ...
  then
    ...
    echo "-----------------------------------------------------------------"
    sh /vagrant_scripts/08_asmfd_label_disk.sh $BOX_DISK_NUM virtualbox
  else
    # Setting-up asmfd disks label
    echo "-----------------------------------------------------------------"
    echo -e "${INFO}`date +%F' '%T`: ASMLib disks label setup"
    echo "-----------------------------------------------------------------"
    sh /vagrant_scripts/08_asmlib_label_disk.sh $BOX_DISK_NUM virtualbox
  fi
  # ---------------------------------------------------------------------
  # ---------------------------------------------------------------------
  ...
  echo "-----------------------------------------------------------------"
  expect /vagrant_scripts/07_setup_user_equ.expect root ${ROOT_PASSWORD} ${NODE1_HOSTNAME} ${NODE1_HOSTNAME} ${GI_HOME}/oui/prov/resources/scripts/sshUserSetup.sh
  ...
  echo "-----------------------------------------------------------------"
  sh /vagrant_scripts/12_Setup_FPP.sh
fi
