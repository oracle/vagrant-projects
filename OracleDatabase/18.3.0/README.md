...
2. Change into the `vagrant-boxes/OracleDatabase/18.3.0` folder
...
* `NAME` (default: `oracle-18c-vagrant`): VM name.
...
* `VM_ORACLE_HOME` (default: `/opt/oracle/product/18c/dbhome_1`): Oracle home directory.
