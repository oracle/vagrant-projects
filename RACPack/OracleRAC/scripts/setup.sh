...
#--------------------------------------------------------------------
# Setting-up /u01 disk
sh /vagrant_scripts/01_setup_u01.sh $BOX_DISK_NUM $PROVIDER
...
sh /vagrant_scripts/05_setup_shared_disks.sh $BOX_DISK_NUM $PROVIDER
...
then
  ...
  echo "-----------------------------------------------------------------"
  sh /vagrant_scripts/08_asmfd_label_disk.sh $BOX_DISK_NUM $PROVIDER
else
  # Setting-up asmfd disks label
  echo "-----------------------------------------------------------------"
  echo -e "${INFO}`date +%F' '%T`: ASMLib disks label setup"
  echo "-----------------------------------------------------------------"
  sh /vagrant_scripts/08_asmlib_label_disk.sh $BOX_DISK_NUM $PROVIDER
fi
# ---------------------------------------------------------------------
# ---------------------------------------------------------------------
